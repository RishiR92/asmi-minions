...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-hover tap-glow",
        ...
        gradient: "gradient-primary text-white shadow-glow hover:shadow-glow hover:scale-[1.02] cta-glow tap-glow font-medium",
        pill: "bg-muted text-foreground hover:bg-primary hover:text-primary-foreground rounded-full shadow-soft transition-all duration-300",
      },
      size: {

    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-xl border-b border-border/40">
        <div className="flex items-center gap-2 p-3 sm:p-5">
          ...
          <h1 className="text-lg sm:text-2xl font-semibold text-foreground">Today</h1>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-5 space-y-4 sm:space-y-6">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-foreground">Urgent Deadlines</h2>
          </div>
          <div className="space-y-2">
            {urgentDeadlines.map((item) => (
              <div key={item.id} className="flex items-center justify-between p-2 sm:p-3 rounded-xl bg-background/40">
                ...
                <Button size="sm" variant="ghost" className="rounded-full h-7 sm:h-8 px-3 sm:px-4 text-[10px] sm:text-xs text-primary">
                  Notes
                </Button>
              </div>
            ))}
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-foreground">Today's Meetings</h2>
          </div>
          <div className="space-y-2">
            {meetings.map((item) => (
              <div key={item.id} className="flex items-center justify-between p-2 sm:p-3 rounded-xl bg-background/40">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-foreground">Health & Wellness</h2>
          </div>
          <div className="space-y-2">
              ...
              <div key={item.id} className="flex items-center justify-between p-2 sm:p-3 rounded-xl bg-background/40">
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <p className="text-[10px] sm:text-xs text-muted-foreground">{item.location}</p>
                  </div>
                </div>
                <Button size="sm" variant="outline" className="rounded-full h-7 sm:h-8 px-3 sm:px-4 text-[10px] sm:text-xs">
                  Directions

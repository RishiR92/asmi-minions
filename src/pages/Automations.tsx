  ...
  return (
    <div className="min-h-screen pt-safe pb-safe pb-20">
      ...
      <div className="glass-sheet border-b border-border/30 sticky top-0 pt-safe z-40">
        <div className="max-w-full sm:max-w-lg mx-auto px-6 sm:px-6 py-5 sm:py-6">
          <motion.div
      ...
      {/* Automations List */}
      <div className="max-w-full sm:max-w-lg mx-auto px-6 sm:px-6 py-5 sm:py-6 space-y-3">
